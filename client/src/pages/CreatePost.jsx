                ...
                <div>
                  ...
                  <div className="image_upload_container md:p-5 md:border-2 bg-transparent border-dashed rounded-sm md:flex items-center justify-center gap-2">
                    <input
                      ...
                      accept="image/*"
                      type="file"
                      className={`file-input file:bg-brand-blue bg-red-00 ${loading ? "md:w-4/6" : "md:w-4/5"
                        } w-full`}
                    />
                    <button
                      ...
                      type="button"
                      className={`w-full text-green-600 text-sm py-2 border-2 border-green-600 rounded-md mt-2 uppercase font-heading  ${loading ? "md:w-2/6" : "md:w-1/5"
