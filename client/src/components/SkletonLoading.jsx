    ...
    return (
        <>
            <div className='grid sm:hidden'>
                <div className="mx-auto bg-brand-blue/25  shadow-lg w-full max-w-xs rounded-sm">
            ...
            <div className='hidden lg:hidden sm:grid grid-cols-2 gap-5'>
                <div className="mx-auto bg-brand-blue/25  shadow-lg w-full max-w-xs rounded-sm">
                    <div className="h-48 p-3 overflow-hidden bg-gray-200 animate-pulse">
                    </div>
                    <div className="p-3 h-">
            ...
            <div className='hidden xl:hidden  lg:grid grid-cols-3 gap-5'>
                <div className="mx-auto bg-brand-blue/25  shadow-lg w-full max-w-xs rounded-sm">
                    <div className="h-48 p-3 overflow-hidden bg-gray-200 animate-pulse">
                    </div>
                    <div className="p-3 h-">
